...
import { getPostBySlug, getPostSlugs, formatDate, getTagUrl, getRecentPosts } from '@/lib/blog';
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const { title, excerpt, speakerName } = post.frontmatter;
  ...
  return {
    ...
    openGraph: {
      ...
      description: excerpt,
      type: 'article',
      authors: speakerName ? [speakerName] : undefined,
    },
  };
}
            ...
            {speakerName && (
              <div className="not-prose card mb-8">
                <div className="card-header">
                  <h2 className="card-title">About the Speaker</h2>
                </div>
              ...
              <div className="card">
                ...
                <div className="card-content space-y-4">
                  {recentPosts.map((post) => (
                    <div key={post.slug} className="border-b border-light-border dark:border-dark-border last:border-b-0 pb-4 last:pb-0">
                      <Link
