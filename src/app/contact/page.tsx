...
export const metadata = {
  ...
  description: 'Contact ETSA for speaking opportunities, partnership inquiries, or general questions about our community.',
};
        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              or exploring partnership opportunities, we&apos;re here to help. Use the form
          ...
          <div className="space-y-6">
              ...
              <div className="card-content">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-etsa-primary/10 dark:bg-etsa-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-etsa-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-2">
                      Use the contact form to reach out for general inquiries, speaking proposals, or partnership opportunities.
                    </p>
            ...
            <div className="card">
              <div className="card-content">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-etsa-primary/10 dark:bg-etsa-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-etsa-primary" fill="currentColor" viewBox="0 0 24 24">
